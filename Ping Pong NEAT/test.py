...
class PongGame:
    ...
    def train_ai(self, genome1, genome2, config):
        ...
        while run:
            ...
            output1 = network1.activate((self.left_paddle.y, self.ball.y, abs(self.left_paddle.x - self.ball.x)))
            ...
            output2 = network2.activate((self.right_paddle.y, self.ball.y, abs(self.right_paddle.x - self.ball.x)))
...
def eval_genomes(genomes, config):
    ...
    for genome_id, genome1 in genomes:
        genome1.fitness = 0  
        for genome_id2, genome2 in genomes:
            if genome_id != genome_id2:  
